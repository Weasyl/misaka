...
tests = (
    ...
    ('ordered_list', {
        'supplied': """\
            ...
            """,
        'expected': """\
            [LIST ordered=true block=false prefix=1]
    ...
    ('unordered_list', {
        'supplied': """\
            ...
            """,
        'expected': """\
            [LIST ordered=false block=false prefix=None]
    ...
    ('unordered_list_block', {
        'supplied': """\
             ...
             """,
        'expected': """\
            [LIST ordered=false block=true prefix=None]
...
class TestRenderer(m.BaseRenderer):
    ...
    def list(self, content, is_ordered, is_block, prefix):
        ...
        return '[LIST ordered={1} block={2} prefix={3}]\n{0}'.format(content, ordered, block, prefix)
