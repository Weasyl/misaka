...
struct hoedown_renderer {
    ...
    void (*list)(hoedown_buffer *ob, const hoedown_buffer *content, hoedown_list_flags flags, const uint8_t *ol_prefix, const hoedown_renderer_data *data);
...
extern "Python" void _misaka_list(hoedown_buffer *ob, const hoedown_buffer *content, hoedown_list_flags flags, const uint8_t* ol_prefix, const hoedown_renderer_data *data);
